# ZarzadzanieUslugamiBiznesowymiIWewnetrznymi
...
To build the final jar and optimize the ZarzadzanieUslugamiBiznesowymiIWewnetrznymi application for production, run:

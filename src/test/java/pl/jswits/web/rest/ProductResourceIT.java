...
class ProductResourceIT {
    ...
    private static final ProductType DEFAULT_TYPE = ProductType.CRITICAL;
    private static final ProductType UPDATED_TYPE = ProductType.IMPORTANT;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).type(DEFAULT_TYPE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).type(UPDATED_TYPE);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).type(UPDATED_TYPE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.type(UPDATED_TYPE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).type(UPDATED_TYPE);
